...
import org.mybatis.generator.enhanced.InnerTypeFullyQualifiedJavaType;
import org.mybatis.generator.hook.ILombokPluginHook;
import org.mybatis.generator.hook.IModelBuilderPluginHook;
import org.mybatis.generator.internal.util.JavaBeansUtil;
import org.mybatis.generator.utils.FormatTools;
import org.mybatis.generator.utils.JavaElementGeneratorTools;
...
//            innerClass.setSuperClass(topLevelClass.getSuperClass().getShortName() + "." + BUILDER_CLASS_NAME);
            //TODO 2020年2月8日
            innerClass.setSuperClass(topLevelClass.getSuperClass().getClass().getSimpleName() + "." + BUILDER_CLASS_NAME);
        }
