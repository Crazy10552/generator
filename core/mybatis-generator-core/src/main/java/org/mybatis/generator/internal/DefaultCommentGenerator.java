...
//        topLevelClass.addJavaDocLine(" */"); //$NON-NLS-1$
        ...
        //TODO 2020-2-13 Bean的类注释
        String shortName = topLevelClass.getType().getShortName();
        topLevelClass.addJavaDocLine(new StringBuilder().append(" * ").append(shortName).append("类注释").toString());
        topLevelClass.addJavaDocLine(" * @author tianyang");
        topLevelClass.addJavaDocLine(" * @date "+new Date());
        topLevelClass.addJavaDocLine(" * @desc "+introspectedTable.getRemarks());
        topLevelClass.addJavaDocLine(new StringBuilder().append(" * 数据库表：").append(introspectedTable.getFullyQualifiedTable()).toString());
...
//        innerEnum.addJavaDocLine(sb.toString());
        ...
        String shortName = innerEnum.getType().getShortName();
        innerEnum.addJavaDocLine(new StringBuilder().append(" * ").append(shortName).append("类注释").toString());
        innerEnum.addJavaDocLine(" * @author tianyang");
        innerEnum.addJavaDocLine(" * @date "+new Date());
        innerEnum.addJavaDocLine(" * @desc "+introspectedTable.getRemarks());
        innerEnum.addJavaDocLine(new StringBuilder().append(" * 数据库表：").append(introspectedTable.getFullyQualifiedTable()).toString());
